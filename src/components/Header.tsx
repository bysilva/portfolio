...
function LanguageSelector() {
  ...
  const handleChangeLanguage = (
    ...
    const selectedLocale = event.target.value as 'en' | 'es'
  ...
  return (
    <div className="relative inline-block text-left">
      <select
        ...
        className="appearance-none rounded-md border border-gray-300 bg-white px-4 py-2 text-sm text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100"
        style={{ backgroundImage: 'none' }} // Quita la imagen de fondo
      >
